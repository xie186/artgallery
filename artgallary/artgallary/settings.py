"""
Django settings for artgallary project.
...
SECRET_KEY = 'jf4c3d^8c(8s4ezgzp#@x4bxl6p9$ry9xn8ibrw12g1^!*+x53'
...
STATICFILES_DIRS = [
    TEMPLATES_DIR,  # Here you tell django to look for a folder named 'assets'
    MEDIA_ROOT,
]
